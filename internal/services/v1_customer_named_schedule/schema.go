...
var _ resource.ResourceWithConfigValidators = (*V1CustomerNamedScheduleResource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"data": schema.ListNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectListType[V1CustomerNamedScheduleDataModel](ctx),
...
func (r *V1CustomerNamedScheduleResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = ResourceSchema(ctx)
}

func (r *V1CustomerNamedScheduleResource) ConfigValidators(_ context.Context) []resource.ConfigValidator {
