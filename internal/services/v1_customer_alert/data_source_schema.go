...
func DataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"plans_or_contracts": schema.StringAttribute{
				Description: "When parallel alerts are enabled during migration, this flag denotes whether to fetch alerts for plans or contracts.\nAvailable values: \"PLANS\", \"CONTRACTS\".",
				Optional:    true,
				Validators: []validator.String{
					stringvalidator.OneOfCaseInsensitive("PLANS", "CONTRACTS"),
				},
			},
