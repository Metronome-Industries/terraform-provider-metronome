...
var _ datasource.DataSourceWithConfigValidators = (*V1CustomerInvoiceDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"data": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"credit_type": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataCreditTypeDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"id": schema.StringAttribute{
								Computed: true,
							},
					...
					"line_items": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[V1CustomerInvoiceDataLineItemsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"credit_type": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsCreditTypeDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
											Computed: true,
										},
								...
								"applied_commit_or_credit": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsAppliedCommitOrCreditDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
											Computed: true,
										},
								...
								"list_price": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsListPriceDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										...
										"credit_type": schema.SingleNestedAttribute{
											Computed:   true,
											CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsListPriceCreditTypeDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"id": schema.StringAttribute{
													Computed: true,
												},
										...
										"tiers": schema.ListNestedAttribute{
											...
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1CustomerInvoiceDataLineItemsListPriceTiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"price": schema.Float64Attribute{
														Computed: true,
								...
								"postpaid_commit": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsPostpaidCommitDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
											Computed: true,
										},
								...
								"sub_line_items": schema.ListNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectListType[V1CustomerInvoiceDataLineItemsSubLineItemsDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"custom_fields": schema.MapAttribute{
												Computed:    true,
											...
											"tier_period": schema.SingleNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsSubLineItemsTierPeriodDataSourceModel](ctx),
												Attributes: map[string]schema.Attribute{
													"starting_at": schema.StringAttribute{
														Computed:   true,
														CustomType: timetypes.RFC3339Type{},
											...
											"tiers": schema.ListNestedAttribute{
												Computed:   true,
												CustomType: customfield.NewNestedObjectListType[V1CustomerInvoiceDataLineItemsSubLineItemsTiersDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"price": schema.Float64Attribute{
															Computed: true,
								...
								"tier": schema.SingleNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataLineItemsTierDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
					...
					"correction_record": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataCorrectionRecordDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"corrected_external_invoice": schema.SingleNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataCorrectionRecordCorrectedExternalInvoiceDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"external_invoice": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataExternalInvoiceDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"billing_provider_type": schema.StringAttribute{
								Description: `Available values: "aws_marketplace", "stripe", "netsuite", "custom", "azure_marketplace", "quickbooks_online", "workday", "gcp_marketplace".`,
								Computed:    true,
					...
					"invoice_adjustments": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[V1CustomerInvoiceDataInvoiceAdjustmentsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"credit_type": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataInvoiceAdjustmentsCreditTypeDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"id": schema.StringAttribute{
											Computed: true,
										},
					...
					"reseller_royalty": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[V1CustomerInvoiceDataResellerRoyaltyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"aws_options": schema.SingleNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataResellerRoyaltyAwsOptionsDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
							...
							"gcp_options": schema.SingleNestedAttribute{
								Computed:   true,
								CustomType: customfield.NewNestedObjectType[V1CustomerInvoiceDataResellerRoyaltyGcpOptionsDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
...
func (d *V1CustomerInvoiceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *V1CustomerInvoiceDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
