...
var _ datasource.DataSourceWithConfigValidators = (*V1ContractProductDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"data": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[V1ContractProductDataDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					...
					"current": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[V1ContractProductDataCurrentDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							...
							"quantity_conversion": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[V1ContractProductDataCurrentQuantityConversionDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
							...
							"quantity_rounding": schema.SingleNestedAttribute{
								...
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[V1ContractProductDataCurrentQuantityRoundingDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
					...
					"initial": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[V1ContractProductDataInitialDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"created_at": schema.StringAttribute{
								Computed:   true,
								CustomType: timetypes.RFC3339Type{},
							...
							"quantity_conversion": schema.SingleNestedAttribute{
								Description: `Optional. Only valid for USAGE products. If provided, the quantity will be converted using the provided conversion factor and operation. For example, if the operation is "multiply" and the conversion factor is 100, then the quantity will be multiplied by 100. This can be used in cases where data is sent in one unit and priced in another.  For example, data could be sent in MB and priced in GB. In this case, the conversion factor would be 1024 and the operation would be "divide".`,
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[V1ContractProductDataInitialQuantityConversionDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"conversion_factor": schema.Float64Attribute{
										Description: "The factor to multiply or divide the quantity by.",
										Computed:    true,
							...
							"quantity_rounding": schema.SingleNestedAttribute{
								Description: `Optional. Only valid for USAGE products. If provided, the quantity will be rounded using the provided rounding method and decimal places. For example, if the method is "round up" and the decimal places is 0, then the quantity will be rounded up to the nearest integer.`,
								Computed:    true,
								CustomType:  customfield.NewNestedObjectType[V1ContractProductDataInitialQuantityRoundingDataSourceModel](ctx),
								Attributes: map[string]schema.Attribute{
									"decimal_places": schema.Float64Attribute{
										Computed: true,
										Validators: []validator.Float64{
					...
					"updates": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[V1ContractProductDataUpdatesDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"quantity_conversion": schema.SingleNestedAttribute{
									Description: `Optional. Only valid for USAGE products. If provided, the quantity will be converted using the provided conversion factor and operation. For example, if the operation is "multiply" and the conversion factor is 100, then the quantity will be multiplied by 100. This can be used in cases where data is sent in one unit and priced in another.  For example, data could be sent in MB and priced in GB. In this case, the conversion factor would be 1024 and the operation would be "divide".`,
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1ContractProductDataUpdatesQuantityConversionDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"conversion_factor": schema.Float64Attribute{
											Description: "The factor to multiply or divide the quantity by.",
											Computed:    true,
								...
								"quantity_rounding": schema.SingleNestedAttribute{
									Description: `Optional. Only valid for USAGE products. If provided, the quantity will be rounded using the provided rounding method and decimal places. For example, if the method is "round up" and the decimal places is 0, then the quantity will be rounded up to the nearest integer.`,
									Computed:    true,
									CustomType:  customfield.NewNestedObjectType[V1ContractProductDataUpdatesQuantityRoundingDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"decimal_places": schema.Float64Attribute{
											Computed: true,
											Validators: []validator.Float64{
...
func (d *V1ContractProductDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *V1ContractProductDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
