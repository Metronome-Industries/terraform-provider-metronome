...
type V2ContractDataSourceModel struct {
	...
	AsOfDate       timetypes.RFC3339                                       `tfsdk:"as_of_date" json:"as_of_date,optional" format:"date-time"`
...
type V2ContractDataDataSourceModel struct {
	...
	Subscriptions                        customfield.NestedObjectList[V2ContractDataSubscriptionsDataSourceModel]                    `tfsdk:"subscriptions" json:"subscriptions,computed"`
...
type V2ContractDataCommitsDataSourceModel struct {
	...
	SalesforceOpportunityID types.String                                                                  `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V2ContractDataCommitsSpecifiersDataSourceModel]  `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataCommitsSpecifiersDataSourceModel struct {
...
type V2ContractDataCreditsDataSourceModel struct {
	...
	Priority                types.Float64                                                                `tfsdk:"priority" json:"priority,computed"`
	SalesforceOpportunityID types.String                                                                 `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V2ContractDataCreditsSpecifiersDataSourceModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataCreditsSpecifiersDataSourceModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataPrepaidBalanceThresholdConfigurationCommitDataSourceModel struct {
	...
	Description           types.String                                                                                                    `tfsdk:"description" json:"description,computed"`
	Name                  types.String                                                                                                    `tfsdk:"name" json:"name,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}

type V2ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataRecurringCommitsDataSourceModel struct {
	...
	RolloverFraction      types.Float64                                                                         `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataRecurringCommitsSpecifiersDataSourceModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataRecurringCommitsSpecifiersDataSourceModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataRecurringCreditsDataSourceModel struct {
	...
	RecurrenceFrequency   types.String                                                                          `tfsdk:"recurrence_frequency" json:"recurrence_frequency,computed"`
	RolloverFraction      types.Float64                                                                         `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataRecurringCreditsSpecifiersDataSourceModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataRecurringCreditsSpecifiersDataSourceModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataSubscriptionsDataSourceModel struct {
	CollectionSchedule types.String                                                                             `tfsdk:"collection_schedule" json:"collection_schedule,computed"`
	Proration          customfield.NestedObject[V2ContractDataSubscriptionsProrationDataSourceModel]            `tfsdk:"proration" json:"proration,computed"`
	QuantitySchedule   customfield.NestedObjectList[V2ContractDataSubscriptionsQuantityScheduleDataSourceModel] `tfsdk:"quantity_schedule" json:"quantity_schedule,computed"`
	StartingAt         timetypes.RFC3339                                                                        `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	SubscriptionRate   customfield.NestedObject[V2ContractDataSubscriptionsSubscriptionRateDataSourceModel]     `tfsdk:"subscription_rate" json:"subscription_rate,computed"`
	ID                 types.String                                                                             `tfsdk:"id" json:"id,computed"`
	CustomFields       customfield.Map[types.String]                                                            `tfsdk:"custom_fields" json:"custom_fields,computed"`
	Description        types.String                                                                             `tfsdk:"description" json:"description,computed"`
	EndingBefore       timetypes.RFC3339                                                                        `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
...
type V2ContractDataSubscriptionsProrationDataSourceModel struct {
	InvoiceBehavior types.String `tfsdk:"invoice_behavior" json:"invoice_behavior,computed"`
	IsProrated      types.Bool   `tfsdk:"is_prorated" json:"is_prorated,computed"`
}

type V2ContractDataSubscriptionsQuantityScheduleDataSourceModel struct {
	Quantity     types.Float64     `tfsdk:"quantity" json:"quantity,computed"`
	StartingAt   timetypes.RFC3339 `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	EndingBefore timetypes.RFC3339 `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
}

type V2ContractDataSubscriptionsSubscriptionRateDataSourceModel struct {
	BillingFrequency types.String                                                                                `tfsdk:"billing_frequency" json:"billing_frequency,computed"`
	Product          customfield.NestedObject[V2ContractDataSubscriptionsSubscriptionRateProductDataSourceModel] `tfsdk:"product" json:"product,computed"`
}

type V2ContractDataSubscriptionsSubscriptionRateProductDataSourceModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Name types.String `tfsdk:"name" json:"name,computed"`
}
