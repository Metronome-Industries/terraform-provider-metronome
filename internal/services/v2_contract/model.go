...
type V2ContractModel struct {
	...
	AddSubscriptions                           *[]*V2ContractAddSubscriptionsModel                        `tfsdk:"add_subscriptions" json:"add_subscriptions,optional,no_refresh"`
	...
	UpdateRecurringCommits                     *[]*V2ContractUpdateRecurringCommitsModel                  `tfsdk:"update_recurring_commits" json:"update_recurring_commits,optional,no_refresh"`
	UpdateRecurringCredits                     *[]*V2ContractUpdateRecurringCreditsModel                  `tfsdk:"update_recurring_credits" json:"update_recurring_credits,optional,no_refresh"`
	...
	UpdateSubscriptions                        *[]*V2ContractUpdateSubscriptionsModel                     `tfsdk:"update_subscriptions" json:"update_subscriptions,optional,no_refresh"`
...
type V2ContractAddCommitsModel struct {
	...
	Specifiers            *[]*V2ContractAddCommitsSpecifiersModel     `tfsdk:"specifiers" json:"specifiers,optional"`
...
type V2ContractAddCommitsSpecifiersModel struct {
...
type V2ContractAddCreditsModel struct {
	...
	Priority              types.Float64                            `tfsdk:"priority" json:"priority,optional"`
	RateType              types.String                             `tfsdk:"rate_type" json:"rate_type,optional"`
	Specifiers            *[]*V2ContractAddCreditsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
}
...
type V2ContractAddCreditsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V2ContractAddPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                               `tfsdk:"description" json:"description,optional"`
	Name                  types.String                                                               `tfsdk:"name" json:"name,optional"`
	Specifiers            *[]*V2ContractAddPrepaidBalanceThresholdConfigurationCommitSpecifiersModel `tfsdk:"specifiers" json:"specifiers,optional"`
}

type V2ContractAddPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V2ContractAddRecurringCommitsModel struct {
	...
	RolloverFraction      types.Float64                                     `tfsdk:"rollover_fraction" json:"rollover_fraction,optional"`
	Specifiers            *[]*V2ContractAddRecurringCommitsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
	TemporaryID           types.String                                      `tfsdk:"temporary_id" json:"temporary_id,optional"`
}
...
type V2ContractAddRecurringCommitsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V2ContractAddRecurringCreditsModel struct {
	...
	RecurrenceFrequency   types.String                                      `tfsdk:"recurrence_frequency" json:"recurrence_frequency,optional"`
	RolloverFraction      types.Float64                                     `tfsdk:"rollover_fraction" json:"rollover_fraction,optional"`
	Specifiers            *[]*V2ContractAddRecurringCreditsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
	TemporaryID           types.String                                      `tfsdk:"temporary_id" json:"temporary_id,optional"`
}
...
type V2ContractAddRecurringCreditsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V2ContractAddSubscriptionsModel struct {
	CollectionSchedule types.String                                     `tfsdk:"collection_schedule" json:"collection_schedule,required"`
	InitialQuantity    types.Float64                                    `tfsdk:"initial_quantity" json:"initial_quantity,required"`
	Proration          *V2ContractAddSubscriptionsProrationModel        `tfsdk:"proration" json:"proration,required"`
	SubscriptionRate   *V2ContractAddSubscriptionsSubscriptionRateModel `tfsdk:"subscription_rate" json:"subscription_rate,required"`
	CustomFields       *map[string]types.String                         `tfsdk:"custom_fields" json:"custom_fields,optional"`
	Description        types.String                                     `tfsdk:"description" json:"description,optional"`
	EndingBefore       timetypes.RFC3339                                `tfsdk:"ending_before" json:"ending_before,optional" format:"date-time"`
	Name               types.String                                     `tfsdk:"name" json:"name,optional"`
...
type V2ContractAddSubscriptionsProrationModel struct {
	InvoiceBehavior types.String `tfsdk:"invoice_behavior" json:"invoice_behavior,optional"`
	IsProrated      types.Bool   `tfsdk:"is_prorated" json:"is_prorated,optional"`
}

type V2ContractAddSubscriptionsSubscriptionRateModel struct {
	BillingFrequency types.String `tfsdk:"billing_frequency" json:"billing_frequency,required"`
	ProductID        types.String `tfsdk:"product_id" json:"product_id,required"`
}
...
type V2ContractUpdatePrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Name                  types.String                                                                  `tfsdk:"name" json:"name,optional"`
	ProductID             types.String                                                                  `tfsdk:"product_id" json:"product_id,optional"`
	Specifiers            *[]*V2ContractUpdatePrepaidBalanceThresholdConfigurationCommitSpecifiersModel `tfsdk:"specifiers" json:"specifiers,optional"`
}

type V2ContractUpdatePrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V2ContractUpdateRecurringCommitsModel struct {
	RecurringCommitID types.String                                        `tfsdk:"recurring_commit_id" json:"recurring_commit_id,required"`
	AccessAmount      *V2ContractUpdateRecurringCommitsAccessAmountModel  `tfsdk:"access_amount" json:"access_amount,optional"`
	EndingBefore      timetypes.RFC3339                                   `tfsdk:"ending_before" json:"ending_before,optional" format:"date-time"`
	InvoiceAmount     *V2ContractUpdateRecurringCommitsInvoiceAmountModel `tfsdk:"invoice_amount" json:"invoice_amount,optional"`
}

type V2ContractUpdateRecurringCommitsAccessAmountModel struct {
	Quantity  types.Float64 `tfsdk:"quantity" json:"quantity,optional"`
	UnitPrice types.Float64 `tfsdk:"unit_price" json:"unit_price,optional"`
}

type V2ContractUpdateRecurringCommitsInvoiceAmountModel struct {
	Quantity  types.Float64 `tfsdk:"quantity" json:"quantity,optional"`
	UnitPrice types.Float64 `tfsdk:"unit_price" json:"unit_price,optional"`
}

type V2ContractUpdateRecurringCreditsModel struct {
	RecurringCreditID types.String                                       `tfsdk:"recurring_credit_id" json:"recurring_credit_id,required"`
	AccessAmount      *V2ContractUpdateRecurringCreditsAccessAmountModel `tfsdk:"access_amount" json:"access_amount,optional"`
	EndingBefore      timetypes.RFC3339                                  `tfsdk:"ending_before" json:"ending_before,optional" format:"date-time"`
}

type V2ContractUpdateRecurringCreditsAccessAmountModel struct {
	Quantity  types.Float64 `tfsdk:"quantity" json:"quantity,optional"`
	UnitPrice types.Float64 `tfsdk:"unit_price" json:"unit_price,optional"`
}
...
type V2ContractUpdateSubscriptionsModel struct {
	SubscriptionID  types.String                                          `tfsdk:"subscription_id" json:"subscription_id,required"`
	EndingBefore    timetypes.RFC3339                                     `tfsdk:"ending_before" json:"ending_before,optional" format:"date-time"`
	QuantityUpdates *[]*V2ContractUpdateSubscriptionsQuantityUpdatesModel `tfsdk:"quantity_updates" json:"quantity_updates,optional"`
}

type V2ContractUpdateSubscriptionsQuantityUpdatesModel struct {
	StartingAt    timetypes.RFC3339 `tfsdk:"starting_at" json:"starting_at,required" format:"date-time"`
	Quantity      types.Float64     `tfsdk:"quantity" json:"quantity,optional"`
	QuantityDelta types.Float64     `tfsdk:"quantity_delta" json:"quantity_delta,optional"`
}
...
type V2ContractDataModel struct {
	...
	Subscriptions                        customfield.NestedObjectList[V2ContractDataSubscriptionsModel]                    `tfsdk:"subscriptions" json:"subscriptions,computed"`
...
type V2ContractDataCommitsModel struct {
	...
	SalesforceOpportunityID types.String                                                        `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V2ContractDataCommitsSpecifiersModel]  `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataCommitsSpecifiersModel struct {
...
type V2ContractDataCreditsModel struct {
	...
	Priority                types.Float64                                                      `tfsdk:"priority" json:"priority,computed"`
	SalesforceOpportunityID types.String                                                       `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V2ContractDataCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                                                          `tfsdk:"description" json:"description,computed"`
	Name                  types.String                                                                                          `tfsdk:"name" json:"name,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}

type V2ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataRecurringCommitsModel struct {
	...
	RolloverFraction      types.Float64                                                               `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataRecurringCommitsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataRecurringCommitsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataRecurringCreditsModel struct {
	...
	RecurrenceFrequency   types.String                                                                `tfsdk:"recurrence_frequency" json:"recurrence_frequency,computed"`
	RolloverFraction      types.Float64                                                               `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V2ContractDataRecurringCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V2ContractDataRecurringCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V2ContractDataSubscriptionsModel struct {
	CollectionSchedule types.String                                                                   `tfsdk:"collection_schedule" json:"collection_schedule,computed"`
	Proration          customfield.NestedObject[V2ContractDataSubscriptionsProrationModel]            `tfsdk:"proration" json:"proration,computed"`
	QuantitySchedule   customfield.NestedObjectList[V2ContractDataSubscriptionsQuantityScheduleModel] `tfsdk:"quantity_schedule" json:"quantity_schedule,computed"`
	StartingAt         timetypes.RFC3339                                                              `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	SubscriptionRate   customfield.NestedObject[V2ContractDataSubscriptionsSubscriptionRateModel]     `tfsdk:"subscription_rate" json:"subscription_rate,computed"`
	ID                 types.String                                                                   `tfsdk:"id" json:"id,computed"`
	CustomFields       customfield.Map[types.String]                                                  `tfsdk:"custom_fields" json:"custom_fields,computed"`
	Description        types.String                                                                   `tfsdk:"description" json:"description,computed"`
	EndingBefore       timetypes.RFC3339                                                              `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
...
type V2ContractDataSubscriptionsProrationModel struct {
	InvoiceBehavior types.String `tfsdk:"invoice_behavior" json:"invoice_behavior,computed"`
	IsProrated      types.Bool   `tfsdk:"is_prorated" json:"is_prorated,computed"`
}

type V2ContractDataSubscriptionsQuantityScheduleModel struct {
	Quantity     types.Float64     `tfsdk:"quantity" json:"quantity,computed"`
	StartingAt   timetypes.RFC3339 `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	EndingBefore timetypes.RFC3339 `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
}

type V2ContractDataSubscriptionsSubscriptionRateModel struct {
	BillingFrequency types.String                                                                      `tfsdk:"billing_frequency" json:"billing_frequency,computed"`
	Product          customfield.NestedObject[V2ContractDataSubscriptionsSubscriptionRateProductModel] `tfsdk:"product" json:"product,computed"`
}

type V2ContractDataSubscriptionsSubscriptionRateProductModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Name types.String `tfsdk:"name" json:"name,computed"`
}
