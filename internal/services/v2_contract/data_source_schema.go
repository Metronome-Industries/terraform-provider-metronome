...
func DataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"as_of_date": schema.StringAttribute{
			...
			"data": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"specifiers": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[V2ContractDataCommitsSpecifiersDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"specifiers": schema.ListNestedAttribute{
									Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[V2ContractDataCreditsSpecifiersDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"presentation_group_values": schema.MapAttribute{
												Computed:    true,
							...
							"commit": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"specifiers": schema.ListNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[V2ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"presentation_group_values": schema.MapAttribute{
													Computed:    true,
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"specifiers": schema.ListNestedAttribute{
									Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[V2ContractDataRecurringCommitsSpecifiersDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"presentation_group_values": schema.MapAttribute{
												Computed:    true,
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"specifiers": schema.ListNestedAttribute{
									Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[V2ContractDataRecurringCreditsSpecifiersDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"presentation_group_values": schema.MapAttribute{
												Computed:    true,
					...
					"subscriptions": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[V2ContractDataSubscriptionsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"proration": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V2ContractDataSubscriptionsProrationDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"quantity_schedule": schema.ListNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectListType[V2ContractDataSubscriptionsQuantityScheduleDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"quantity": schema.Float64Attribute{
												Computed: true,
								...
								"subscription_rate": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V2ContractDataSubscriptionsSubscriptionRateDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"billing_frequency": schema.StringAttribute{
											Description: `Available values: "MONTHLY", "QUARTERLY", "ANNUAL", "WEEKLY".`,
											Computed:    true,
										...
										"product": schema.SingleNestedAttribute{
											Computed:   true,
											CustomType: customfield.NewNestedObjectType[V2ContractDataSubscriptionsSubscriptionRateProductDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"id": schema.StringAttribute{
													Computed: true,
												},
