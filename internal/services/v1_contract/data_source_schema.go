...
func DataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"include_balance": schema.BoolAttribute{
			...
			"include_ledgers": schema.BoolAttribute{
			...
			"data": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"specifiers": schema.ListNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[V1ContractDataAmendmentsCommitsSpecifiersDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
									...
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											...
											"specifiers": schema.ListNestedAttribute{
												Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[V1ContractDataAmendmentsCreditsSpecifiersDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"presentation_group_values": schema.MapAttribute{
															Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataCurrentCommitsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataCurrentCreditsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
									...
									"commit": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"specifiers": schema.ListNestedAttribute{
												...
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[V1ContractDataCurrentPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"presentation_group_values": schema.MapAttribute{
															Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataCurrentRecurringCommitsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataCurrentRecurringCreditsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataInitialCommitsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataInitialCreditsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
									...
									"commit": schema.SingleNestedAttribute{
										...
										Attributes: map[string]schema.Attribute{
											...
											"specifiers": schema.ListNestedAttribute{
												Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown. This field cannot be used together with `applicable_product_ids` or `applicable_product_tags`.",
												Computed:    true,
												CustomType:  customfield.NewNestedObjectListType[V1ContractDataInitialPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel](ctx),
												NestedObject: schema.NestedAttributeObject{
													Attributes: map[string]schema.Attribute{
														"presentation_group_values": schema.MapAttribute{
															Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataInitialRecurringCommitsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
								...
								NestedObject: schema.NestedAttributeObject{
									Attributes: map[string]schema.Attribute{
										...
										"specifiers": schema.ListNestedAttribute{
											Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown.",
											Computed:    true,
											CustomType:  customfield.NewNestedObjectListType[V1ContractDataInitialRecurringCreditsSpecifiersDataSourceModel](ctx),
											NestedObject: schema.NestedAttributeObject{
												Attributes: map[string]schema.Attribute{
													"presentation_group_values": schema.MapAttribute{
														Computed:    true,
							...
							"commit": schema.SingleNestedAttribute{
								...
								Attributes: map[string]schema.Attribute{
									...
									"specifiers": schema.ListNestedAttribute{
										Description: "List of filters that determine what kind of customer usage draws down a commit or credit. A customer's usage needs to meet the condition of at least one of the specifiers to contribute to a commit's or credit's drawdown. This field cannot be used together with `applicable_product_ids` or `applicable_product_tags`.",
										Computed:    true,
										CustomType:  customfield.NewNestedObjectListType[V1ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersDataSourceModel](ctx),
										NestedObject: schema.NestedAttributeObject{
											Attributes: map[string]schema.Attribute{
												"presentation_group_values": schema.MapAttribute{
													Computed:    true,
					...
					"subscriptions": schema.ListNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectListType[V1ContractDataSubscriptionsDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"proration": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V1ContractDataSubscriptionsProrationDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
								...
								"quantity_schedule": schema.ListNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectListType[V1ContractDataSubscriptionsQuantityScheduleDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
											"quantity": schema.Float64Attribute{
												Computed: true,
								...
								"subscription_rate": schema.SingleNestedAttribute{
									Computed:   true,
									CustomType: customfield.NewNestedObjectType[V1ContractDataSubscriptionsSubscriptionRateDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"billing_frequency": schema.StringAttribute{
											Description: `Available values: "MONTHLY", "QUARTERLY", "ANNUAL", "WEEKLY".`,
											Computed:    true,
										...
										"product": schema.SingleNestedAttribute{
											Computed:   true,
											CustomType: customfield.NewNestedObjectType[V1ContractDataSubscriptionsSubscriptionRateProductDataSourceModel](ctx),
											Attributes: map[string]schema.Attribute{
												"id": schema.StringAttribute{
													Computed: true,
												},
