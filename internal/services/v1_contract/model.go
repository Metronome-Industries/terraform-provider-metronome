...
type V1ContractModel struct {
	...
	Subscriptions                        *[]*V1ContractSubscriptionsModel                     `tfsdk:"subscriptions" json:"subscriptions,optional,no_refresh"`
...
type V1ContractCommitsModel struct {
	...
	Specifiers            *[]*V1ContractCommitsSpecifiersModel     `tfsdk:"specifiers" json:"specifiers,optional"`
...
type V1ContractCommitsSpecifiersModel struct {
...
type V1ContractCreditsModel struct {
	...
	Priority              types.Float64                         `tfsdk:"priority" json:"priority,optional"`
	RateType              types.String                          `tfsdk:"rate_type" json:"rate_type,optional"`
	Specifiers            *[]*V1ContractCreditsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
}
...
type V1ContractCreditsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V1ContractPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                            `tfsdk:"description" json:"description,optional"`
	Name                  types.String                                                            `tfsdk:"name" json:"name,optional"`
	Specifiers            *[]*V1ContractPrepaidBalanceThresholdConfigurationCommitSpecifiersModel `tfsdk:"specifiers" json:"specifiers,optional"`
}

type V1ContractPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V1ContractRecurringCommitsModel struct {
	...
	RolloverFraction      types.Float64                                  `tfsdk:"rollover_fraction" json:"rollover_fraction,optional"`
	Specifiers            *[]*V1ContractRecurringCommitsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
	TemporaryID           types.String                                   `tfsdk:"temporary_id" json:"temporary_id,optional"`
}
...
type V1ContractRecurringCommitsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V1ContractRecurringCreditsModel struct {
	...
	RecurrenceFrequency   types.String                                   `tfsdk:"recurrence_frequency" json:"recurrence_frequency,optional"`
	RolloverFraction      types.Float64                                  `tfsdk:"rollover_fraction" json:"rollover_fraction,optional"`
	Specifiers            *[]*V1ContractRecurringCreditsSpecifiersModel  `tfsdk:"specifiers" json:"specifiers,optional"`
	TemporaryID           types.String                                   `tfsdk:"temporary_id" json:"temporary_id,optional"`
}
...
type V1ContractRecurringCreditsSpecifiersModel struct {
	PresentationGroupValues *map[string]types.String `tfsdk:"presentation_group_values" json:"presentation_group_values,optional"`
	PricingGroupValues      *map[string]types.String `tfsdk:"pricing_group_values" json:"pricing_group_values,optional"`
	ProductID               types.String             `tfsdk:"product_id" json:"product_id,optional"`
	ProductTags             *[]types.String          `tfsdk:"product_tags" json:"product_tags,optional"`
...
type V1ContractSubscriptionsModel struct {
	...
	Proration          *V1ContractSubscriptionsProrationModel        `tfsdk:"proration" json:"proration,required"`
	SubscriptionRate   *V1ContractSubscriptionsSubscriptionRateModel `tfsdk:"subscription_rate" json:"subscription_rate,required"`
	CustomFields       *map[string]types.String                      `tfsdk:"custom_fields" json:"custom_fields,optional"`
	Description        types.String                                  `tfsdk:"description" json:"description,optional"`
	EndingBefore       timetypes.RFC3339                             `tfsdk:"ending_before" json:"ending_before,optional" format:"date-time"`
	Name               types.String                                  `tfsdk:"name" json:"name,optional"`
...
type V1ContractSubscriptionsProrationModel struct {
	InvoiceBehavior types.String `tfsdk:"invoice_behavior" json:"invoice_behavior,optional"`
	IsProrated      types.Bool   `tfsdk:"is_prorated" json:"is_prorated,optional"`
}

type V1ContractSubscriptionsSubscriptionRateModel struct {
...
type V1ContractDataModel struct {
	...
	Subscriptions                        customfield.NestedObjectList[V1ContractDataSubscriptionsModel]                    `tfsdk:"subscriptions" json:"subscriptions,computed"`
...
type V1ContractDataAmendmentsCommitsModel struct {
	...
	SalesforceOpportunityID types.String                                                                  `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataAmendmentsCommitsSpecifiersModel]  `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                                  `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataAmendmentsCommitsSpecifiersModel struct {
...
type V1ContractDataAmendmentsCreditsModel struct {
	...
	RateType                types.String                                                                 `tfsdk:"rate_type" json:"rate_type,computed"`
	SalesforceOpportunityID types.String                                                                 `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataAmendmentsCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                                 `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataAmendmentsCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataCurrentCommitsModel struct {
	...
	RolloverFraction        types.Float64                                                              `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	SalesforceOpportunityID types.String                                                               `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataCurrentCommitsSpecifiersModel]  `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                               `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataCurrentCommitsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataCurrentCreditsModel struct {
	...
	RateType                types.String                                                              `tfsdk:"rate_type" json:"rate_type,computed"`
	SalesforceOpportunityID types.String                                                              `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataCurrentCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                              `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataCurrentCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataCurrentPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                                                                 `tfsdk:"description" json:"description,computed"`
	Name                  types.String                                                                                                 `tfsdk:"name" json:"name,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataCurrentPrepaidBalanceThresholdConfigurationCommitSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}

type V1ContractDataCurrentPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataCurrentRecurringCommitsModel struct {
	...
	RolloverFraction      types.Float64                                                                      `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataCurrentRecurringCommitsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V1ContractDataCurrentRecurringCommitsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataCurrentRecurringCreditsModel struct {
	...
	RecurrenceFrequency   types.String                                                                       `tfsdk:"recurrence_frequency" json:"recurrence_frequency,computed"`
	RolloverFraction      types.Float64                                                                      `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataCurrentRecurringCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V1ContractDataCurrentRecurringCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataInitialCommitsModel struct {
	...
	RolloverFraction        types.Float64                                                              `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	SalesforceOpportunityID types.String                                                               `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataInitialCommitsSpecifiersModel]  `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                               `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataInitialCommitsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataInitialCreditsModel struct {
	...
	RateType                types.String                                                              `tfsdk:"rate_type" json:"rate_type,computed"`
	SalesforceOpportunityID types.String                                                              `tfsdk:"salesforce_opportunity_id" json:"salesforce_opportunity_id,computed"`
	Specifiers              customfield.NestedObjectList[V1ContractDataInitialCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
	UniquenessKey           types.String                                                              `tfsdk:"uniqueness_key" json:"uniqueness_key,computed"`
}
...
type V1ContractDataInitialCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataInitialPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                                                                 `tfsdk:"description" json:"description,computed"`
	Name                  types.String                                                                                                 `tfsdk:"name" json:"name,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataInitialPrepaidBalanceThresholdConfigurationCommitSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}

type V1ContractDataInitialPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataInitialRecurringCommitsModel struct {
	...
	RecurrenceFrequency   types.String                                                                       `tfsdk:"recurrence_frequency" json:"recurrence_frequency,computed"`
	RolloverFraction      types.Float64                                                                      `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataInitialRecurringCommitsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V1ContractDataInitialRecurringCommitsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataInitialRecurringCreditsModel struct {
	...
	RecurrenceFrequency   types.String                                                                       `tfsdk:"recurrence_frequency" json:"recurrence_frequency,computed"`
	RolloverFraction      types.Float64                                                                      `tfsdk:"rollover_fraction" json:"rollover_fraction,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataInitialRecurringCreditsSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}
...
type V1ContractDataInitialRecurringCreditsSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataPrepaidBalanceThresholdConfigurationCommitModel struct {
	...
	Description           types.String                                                                                          `tfsdk:"description" json:"description,computed"`
	Name                  types.String                                                                                          `tfsdk:"name" json:"name,computed"`
	Specifiers            customfield.NestedObjectList[V1ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersModel] `tfsdk:"specifiers" json:"specifiers,computed"`
}

type V1ContractDataPrepaidBalanceThresholdConfigurationCommitSpecifiersModel struct {
	PresentationGroupValues customfield.Map[types.String]  `tfsdk:"presentation_group_values" json:"presentation_group_values,computed"`
	PricingGroupValues      customfield.Map[types.String]  `tfsdk:"pricing_group_values" json:"pricing_group_values,computed"`
	ProductID               types.String                   `tfsdk:"product_id" json:"product_id,computed"`
	ProductTags             customfield.List[types.String] `tfsdk:"product_tags" json:"product_tags,computed"`
...
type V1ContractDataSubscriptionsModel struct {
	CollectionSchedule types.String                                                                   `tfsdk:"collection_schedule" json:"collection_schedule,computed"`
	Proration          customfield.NestedObject[V1ContractDataSubscriptionsProrationModel]            `tfsdk:"proration" json:"proration,computed"`
	QuantitySchedule   customfield.NestedObjectList[V1ContractDataSubscriptionsQuantityScheduleModel] `tfsdk:"quantity_schedule" json:"quantity_schedule,computed"`
	StartingAt         timetypes.RFC3339                                                              `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	SubscriptionRate   customfield.NestedObject[V1ContractDataSubscriptionsSubscriptionRateModel]     `tfsdk:"subscription_rate" json:"subscription_rate,computed"`
	ID                 types.String                                                                   `tfsdk:"id" json:"id,computed"`
	CustomFields       customfield.Map[types.String]                                                  `tfsdk:"custom_fields" json:"custom_fields,computed"`
	Description        types.String                                                                   `tfsdk:"description" json:"description,computed"`
	EndingBefore       timetypes.RFC3339                                                              `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
...
type V1ContractDataSubscriptionsProrationModel struct {
	InvoiceBehavior types.String `tfsdk:"invoice_behavior" json:"invoice_behavior,computed"`
	IsProrated      types.Bool   `tfsdk:"is_prorated" json:"is_prorated,computed"`
}

type V1ContractDataSubscriptionsQuantityScheduleModel struct {
	Quantity     types.Float64     `tfsdk:"quantity" json:"quantity,computed"`
	StartingAt   timetypes.RFC3339 `tfsdk:"starting_at" json:"starting_at,computed" format:"date-time"`
	EndingBefore timetypes.RFC3339 `tfsdk:"ending_before" json:"ending_before,computed" format:"date-time"`
}

type V1ContractDataSubscriptionsSubscriptionRateModel struct {
	BillingFrequency types.String                                                                      `tfsdk:"billing_frequency" json:"billing_frequency,computed"`
	Product          customfield.NestedObject[V1ContractDataSubscriptionsSubscriptionRateProductModel] `tfsdk:"product" json:"product,computed"`
}

type V1ContractDataSubscriptionsSubscriptionRateProductModel struct {
	ID   types.String `tfsdk:"id" json:"id,computed"`
	Name types.String `tfsdk:"name" json:"name,computed"`
}
