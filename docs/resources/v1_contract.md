...
- `commit_duration` (Attributes) The amount of time the created commits will be valid for. (see [below for nested schema](#nestedatt--recurring_commits--commit_duration))
...
- `commit_duration` (Attributes) The amount of time the created commits will be valid for. (see [below for nested schema](#nestedatt--recurring_credits--commit_duration))
- `priority` (Number) Will be passed down to the individual commits
- `product_id` (String)
- `starting_at` (String) determines the start time for the first commit
